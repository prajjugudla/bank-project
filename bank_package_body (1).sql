CREATE OR REPLACE PACKAGE BODY DEUTSCHE_BANK IS
...
BEGIN
 ...
 WHEN OTHERS THEN
  NULL;
END ADD_CUST_CONTACT;


PROCEDURE DEL_CUST(P_BANK_CUST_ID BANK_CUST.CUST_ID%TYPE) IS
BEGIN
...
PROCEDURE SB_DEPOSIT (P_TRANS_ACC_NO BANK_TRANSACTION.TRANS_ACC_NO%TYPE,
...
PROCEDURE SB_WITHDRAW (P_TRANS_ACC_NO BANK_TRANSACTION.TRANS_ACC_NO%TYPE,
                          P_TRANS_DESC BANK_TRANSACTION.TRANS_DESC%TYPE,
                          P_TRANS_AMT BANK_TRANSACTION.TRANS_AMT%TYPE) IS
V_COUNT NUMBER;
